...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "color_control_mode_auto",
                default_value="true",
                description="Color control mode (true: auto; false: manual).",
            ),
            DeclareLaunchArgument(
                "color_exposure_usec",
                default_value="10000",
                description="Exposure time in usec (only used if the color control mode is mannual).",
            ),
            launch_ros.actions.Node(
                ...
                parameters=[
                    {
                        "depth_enabled": launch.substitutions.LaunchConfiguration(
                            "depth_enabled"
                        )
                    },
                    {
                        "depth_mode": launch.substitutions.LaunchConfiguration(
                            "depth_mode"
                        )
                    },
                    {
                        "depth_unit": launch.substitutions.LaunchConfiguration(
                            "depth_unit"
                        )
                    },
                    {
                        "color_enabled": launch.substitutions.LaunchConfiguration(
                            "color_enabled"
                        )
                    },
                    {
                        "color_format": launch.substitutions.LaunchConfiguration(
                            "color_format"
                        )
                    },
                    {
                        "color_resolution": launch.substitutions.LaunchConfiguration(
                            "color_resolution"
                        )
                    },
                    {"fps": launch.substitutions.LaunchConfiguration("fps")},
                    {
                        "point_cloud": launch.substitutions.LaunchConfiguration(
                            "point_cloud"
                        )
                    },
                    {
                        "rgb_point_cloud": launch.substitutions.LaunchConfiguration(
                            "rgb_point_cloud"
                        )
                    },
                    {
                        "point_cloud_in_depth_frame": launch.substitutions.LaunchConfiguration(
                            "point_cloud_in_depth_frame"
                        )
                    },
                    {
                        "sensor_sn": launch.substitutions.LaunchConfiguration(
                            "sensor_sn"
                        )
                    },
                    {
                        "recording_file": launch.substitutions.LaunchConfiguration(
                            "recording_file"
                        )
                    },
                    {
                        "recording_loop_enabled": launch.substitutions.LaunchConfiguration(
                            "recording_loop_enabled"
                        )
                    },
                    {
                        "body_tracking_enabled": launch.substitutions.LaunchConfiguration(
                            "body_tracking_enabled"
                        )
                    },
                    {
                    ...
                    {
                        "rescale_ir_to_mono8": launch.substitutions.LaunchConfiguration(
                            "rescale_ir_to_mono8"
                        )
                    },
                    {
                        "ir_mono8_scaling_factor": launch.substitutions.LaunchConfiguration(
                            "ir_mono8_scaling_factor"
                        )
                    },
                    {
                        "imu_rate_target": launch.substitutions.LaunchConfiguration(
                            "imu_rate_target"
                        )
                    },
                    {
                        "wired_sync_mode": launch.substitutions.LaunchConfiguration(
                            "wired_sync_mode"
                        )
                    },
                    {
                    ...
                    {
                        "color_control_mode_auto": launch.substitutions.LaunchConfiguration(
                            "color_control_mode_auto"
                        )
                    },
                    {
                        "color_exposure_usec": launch.substitutions.LaunchConfiguration(
                            "color_exposure_usec"
                        )
                    },
                ],
